...
for kt in kt_range:
	...
	for V in V_range:
		name = f"kl_1.0_ko_1.0_ka_{kt}_kt_{ka}_al_0.0_Ri_1.6_beta_0.5_N_20_d_0.0_ddlog9_V{V:03d}"
...
# Save the figure
fig.savefig('./Plots/B_vstrain_nodisorder.pdf',dpi=600,transparent=True)
